...
Route::middleware(['auth','admin'])->group(function () {
    ...
    //change password
    Route::get('admin/{id}/password', [App\Http\Controllers\Admin\ChangePasswordController::class, 'index'])->name('admin.password.index');
    Route::post('admin/{id}/password', [App\Http\Controllers\Admin\ChangePasswordController::class, 'update'])->name('admin.password.update');
   
    //user
    Route::put('admin/users/{id}/upload-photo', [\App\Http\Controllers\Admin\UserController::class, 'uploadFile'])->name('admin.upload_file');
    ...
    //companies
    Route::get('admin/companies', [App\Http\Controllers\Admin\CompanyController::class, 'index'])->name('admin.companies.index');
    ...
    //jobs
    Route::get('admin/jobs', [App\Http\Controllers\Admin\JobController::class, 'index'])->name('admin.jobs.index');
