...
Route::middleware(['auth','admin'])->group(function () {
    ...
    Route::post('admin/users/active', [\App\Http\Controllers\Admin\UserController::class, 'active'])->name('admin.users.active');
    ...
    Route::post('admin/jobs/approve', [App\Http\Controllers\Admin\JobController::class, 'approve'])->name('admin.jobs.approve');
