...
@section('admin-content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <a href="{{ route('admin.companies.index') }}" class="btn btn-outline-secondary float-right"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.jobs.approve', $job->id) }}" method="post">
                                            ...
                                            <input type="checkbox" name="approve_status" id="" onchange="this.form.submit()"
                                                {{ $job->approve_status == 1 ? 'checked' : '' }}>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.jobs.destroy', $job->id) }}" method="post"
                                            ...
                                            <a href="{{ route('admin.jobs.show', $job->id) }}" class="btn btn-info m-1"
