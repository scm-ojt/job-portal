                        ...
                        <form action="{{ route('jobs.update', $job->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id=""
                                    class="form-control @error('title') is-invalid @enderror" placeholder="Enter Job Title"
                                    value="{{ $job->title }}">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <select name="employment_status" id=""
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="working_hour" id=""
                                    class="form-control @error('working_hour') is-invalid @enderror"
                                    placeholder="Enter working hour" value="{{ $job->working_hour }}">
                                @error('working_hour')
                                    <span class="text-danger text-bold">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_information" id=""
                                    class="form-control @error('contact_information') is-invalid @enderror"
                                    placeholder="Enter contact information" value="{{ $job->contact_information }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="address" id="" cols="3" rows="3" placeholder="Enter address"
                                    class="form-control @error('address') is-invalid @enderror">{{ $job->address }}</textarea>
                                @error('address')
                                    <span class="text-danger text-bold">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="requirement" id="" cols="30" rows="5"
                                    class="form-control @error('requirement') is-invalid @enderror">{{ $job->requirement }}</textarea>
                                @error('requirement')
                                    <span class="text-danger text-bold">{{ $message }}</span>
                                @enderror
                            </div>
